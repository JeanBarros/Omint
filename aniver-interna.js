...
function GetAniver() {
	...
	camlQueryBirth.set_viewXml("<View><Query><Where><And><Eq><FieldRef Name='mes' /><Value Type='Calculated'>"+mesatual+"</Value></Eq><Geq><FieldRef Name='dia' /><Value Type='Calculated'>"+diaatual+"</Value></Geq></And></Where><OrderBy><FieldRef Name='mes' Ascending='True' /><FieldRef Name='dia' Ascending='True' /></OrderBy></Query><ViewFields><FieldRef Name='Title' /><FieldRef Name='email' /><FieldRef Name='mes' /><FieldRef Name='dia' /></ViewFields><QueryOptions /></View>");

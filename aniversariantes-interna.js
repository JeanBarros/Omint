...
$("#aniversariantesinterna").html("Aguardo carregando...");
...
function getAllUsers() {
  ...
  //      var searchTerm = "SPS-Birthday > '2000-01-01'";
       var searchTerm = "PreferredName:'Sharepoint Farm'";
...
function onQuerySuccess() {
     ...
     function onSuccess() {
        ...
        $("#aniversariantesinterna").html(html);
